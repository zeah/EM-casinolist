...
require_once 'casino-taxonomy.php';
require_once 'casino-edit.php';
require_once 'casino-overview.php';

/**
 * 
 */
final class Casino_posttype {
	/* singleton */
	...
	private function __construct() {
		Casino_edit::get_instance();
		Casino_taxonomy::get_instance();
		Casino_overview::get_instance();
